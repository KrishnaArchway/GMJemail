 ...
 *
 * Author : bhattam0 - Amar Bhatt Email:(AMAR_BHATT@ARCHWAY.COM) Ext:(2019) File
 * Name : DMLManager.java Package Name : com.archway.globalemail.email
 *
 * Date : Oct 27, 2005 - 2:58:41 PM
 *
 * Change Date : Oct 27, 2005 - 2:58:41 PM Jan 15, 2006 5:20:40 PM Jan 16, 2006
 * 11:13:34 AM Jan 17, 2006 11:13:34 AM Jan 24, 2006 11:58:17 AM Mar 13, 2006
 * 3:55:51 PM Friday, March 17, 2006 Monday, March 27, 2006 Wednesday, May 17,
 * 2006 Thursday, May 18, 2006 May 30, 2006 11:49:10 AM May 30, 2006 12:07:41 PM
 * Jun 2, 2006 6:37:22 PM Jun 19, 2007 2:49:26 PM Thursday, June 28, 2007 Jul
 * 24, 2007 12:04:37 AM Aug 3, 2007 1:31:02 AM Jan 28, 2008 10:23:19 AM Dec 1,
 * 2009 1:03:41 PM Nov 27, 2012 9:01:53 AM Jul 23, 2014 10:40:18 AM
 *
 * --------------------------------------------------------- Description :- Add
 * Class Description here
 * --------------------------------------------------------- Performs all the
 * DML activity for gmJemail application.
 *
 * Note (May 30, 2006 12:09:44 PM):- In future the ConnectionCacheImpl class
 * needs to upgraded/recoded for JDBC connection pooling to avoid deprecation
...
public class DMLManager {
	...
	/**
	 *
	 * Generates BackOrder data to send out emails, in email_history table. Method
	 * created on Jun 19, 2007 2:51:27 PM
	 *
	 *
	 * @param client
	 * @return
	...
	public boolean CreateBackOrderRecInEmailHistory(String client) {
		...
		try {
			...
			try {
				...
				logger.debug(
						"FINALLY -- Error in DMLManager.java CreateBackOrderRecInEmailHistory " + fin.getMessage());
			}
	...
	public boolean CreateOverLimitRecInEmailHistory(String client) {
		...
		try {
			...
			try {
				...
				logger.debug(
						"FINALLY -- Error in DMLManager.java CreateOverLimitRecInEmailHistory " + fin.getMessage());
			}
	...
	/**
	 * Gets BackOrder Data Information Method created on Jun 19, 2007 4:08:14 PM
	 *
	 ...
	 * @return
	 */
	public EmailClientRecipient[] getEmailClientRecipientRecords(String email_client_id) {
	...
	public EmailClient[] getEmailClientRecords(String whichEmail) {
		...
		try {
			...
			while (rs.next()) {
				 ...
				 * business_partner_id, a.nomenclature_id nomenclature_id, a.invoice_file_id
				 * invoice_file_id, a.trans_id trans_id, b.email_client_id email_client_id,
				 * b.client client, b.job_number_id job_number_id, b.email_type email_type ,
				 * b.sender sender, b.subject subject, b.HTML_FILE_LOCATION_ID
				 * html_file_location_id, d.description file_description, d.path_name path_name,
				 * d.file_name file_name , a.email_history_id email_history_id --amar
				 */
	 ...
	 * @return
	 */
	public EmailClient[] getEmailClientRecords(String whichEmail, String order_number) {
	 ...
	 * @return
	 */
	public EmailClientRecipient[] getOLSpecialEmailClientRecipient(String order_number) {
	 ...
	 * @return
	 */
	public OrderedItems[] getOrderItemsRecords(String client, String order_number) {
	...
	public Order getOrderRecord(String client, String order_number) {
		...
		try {
			...
			while (rs.next()) {
				 ...
				 * order.setCredit_card_expiration_date(rs.getString(
				...
				order.setBill_to_middle_initial(
						StringUtility.processNullToEmpty(rs.getString("bill_to_middle_initial")));
				...
				order.setBill_to_state_province(
						StringUtility.processNullToEmpty(rs.getString("bill_to_state_province")));
				...
				order.setShip_to_middle_initial(
						StringUtility.processNullToEmpty(rs.getString("ship_to_middle_initial")));
				...
				order.setShip_to_state_province(
						StringUtility.processNullToEmpty(rs.getString("ship_to_state_province")));
				...
				order.setCredit_card_expiration_date(
						StringUtility.processNullToEmpty(rs.getString("credit_card_expiration_date")));
				...
				order.setShip_to_e_mail_cc(StringUtility.processNullToEmpty(rs.getString("ship_to_e_mail_cc"))
						.replaceAll("[\\n\\t ]", ""));
				order.setBill_to_e_mail_cc(StringUtility.processNullToEmpty(rs.getString("bill_to_e_mail_cc"))
						.replaceAll("[\\n\\t ]", ""));
	 ...
	 * @return
	 */
	public OverLimit getOverLimitDetails(String client, String order_number, String nomenclature_id
	 ...
	 * @return
	 */
	public EmailClientRecipient[] getOverLimitSpecialEmailClientRecipient(String noMenclatureID, String order_number) {
		...
		try {
			...
			try {
				...
				logger.debug("FINALLY -- Error in DMLManager.java getOverLimitSpecialEmailClientRecipient "
						+ fin.getMessage());
			}
	 ...
	 * @return
	 */
	public Packing getPackingShipmentRecord(String client, String order_number) {
	 ...
	 */
	public OrderedItems[] getPickListOrderedItemsRecords(String client, String order_number) {
	 ...
	 * @return
	 */
	public Receiving getReceivingDetails(String client, String noMenclatureID, String trans_id) {
	 ...
	 * @return
	 */
	public EmailClientRecipient[] getSpecialEmailClientRecipient(String noMenclatureID, String emailType) {
		logger.entering("getSpecialEmailClientRecipient(String , String )");
		Connection conn = null;
		ResultSet rs = null;
		CallableStatement cstmt = null;
	 ...
	 * @return
	 */
	public Email setEmailMessageHeader(EmailClientRecipient ecr[], Order order) {
	...
	public boolean updateEmailHistoryReceiving(String nomenclatureID, String flag, String client) {
