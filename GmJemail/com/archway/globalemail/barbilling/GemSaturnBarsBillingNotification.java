 ...
 * File Name               : GemSaturnBarsBillingNotification.java
 * Package Name            : com.archway.globalemail.barbilling
 *
 * Date                    : Feb 2, 2006 10:16:52 PM
 *
 * Change Date             : Thursday, May 18, 2006
 *                           May 30, 2006 11:13:29 AM
 *                           May 30, 2006 11:50:36 AM
 *                           May 30, 2006 11:51:18 AM
 * 							 May 31, 2006 10:14:32 PM
 *
 * ---------------------------------------------------------
 * Description :- Add Class Description here
 * ---------------------------------------------------------
 */
public class GemSaturnBarsBillingNotification
{
	...
	{
		Logger logger = Logger.getLogger ( "saturnBarBilling" );
		...
		EmailClient emailClient[] = dm.getEmailClientRecords ( "N" );
		System.out.println ( "\n\n\n" );
		System.out.println ( "********************** Saturn Bars Billing Setup (Start) **********************" );
		logger.debug ( "********************** Saturn Bars Billing Setup (Start) **********************" );
		...
		logger.debug ( "********************** Saturn Bars Billing Setup (End) **********************" );
		System.out.println ( "********************** Saturn Bars Billing Setup (End) **********************" );
		//for output in cron email need an RPT at beginning of line.
		System.out.println ( "\nRPT:\tSaturn Bars Billing Setup" );
