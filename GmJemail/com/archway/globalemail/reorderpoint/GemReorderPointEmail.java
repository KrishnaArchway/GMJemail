...
public class GemReorderPointEmail
{
	...
	public static void main ( String [] args )
	{
		...
		EmailClient ec[] = dm.getEmailClientRecords ( "I" );
		for ( int i = 0 ; i < ec.length ; i++ )
		{
			...
			EmailClientRecipient ecr[] = dm.getSpecialEmailClientRecipient ( ec [i].getNomenclature_id () , "I" );
			...
			{
				dm.updateEmailHistory ( ec [i].getEmail_history_id () , "I" );
